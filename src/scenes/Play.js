...
class Play extends Phaser.Scene {
  ...
  createLayers(map) {
    ...
    map.createStaticLayer("distance", tilesetBg).setDepth(-5)
  ...
  onCollect(entity, collectable) {
    ...
    collectable.disableBody(true, true) //disableGameObject, hideGameObject
  }
  ...
  createPlayerColliders(player, { colliders }) {
    ...
    player.addCollider(colliders.projectiles, this.onHit)
  ...
  getPlayerZones(playerZonesLayer) {
    ...
    return {
      start: playerZones.find(({ name }) => name === "startZone"),
      end: playerZones.find(({ name }) => name === "endZone"),
    }
  }
